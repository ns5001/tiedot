...
User.create(name:"Bob", email:"bob@gmail.com", password:"abcabc", profile_pic: "/bob.jpg", company: "Microsoft", position: "Vice President")
User.create(name:"Sam", email:"sam@gmail.com", password:"abcabc", profile_pic: "/sam.jpg", company: "Apple", position: "Head of Public Affairs")
User.create(name:"Tom", email:"tom@gmail.com", password:"abcabc", profile_pic: "/tom.jpg", company: "Samsung", position: "Project Manager")
User.create(name:"Sandy", email:"sandy@gmail.com", password:"abcabc", profile_pic: "/sandy.jpg", company: "Google", position: "Executive Manager")
User.create(name:"Mary", email:"mary@gmail.com", password:"abcabc", profile_pic: "/mary.jpg")
User.create(name:"Charles", email:"charles@gmail.com", password:"abcabc", profile_pic: "/charles.gif")
